...
brfss_location2010 = filter(brfss_smart2010,year == "2010") %>% 
  ...
  filter(n > 7)
```
**Answer:** According to the result of chunk above, the three states**(NJ MA PA)** were observed at 7 or more locations in 2002, while the 11 states**(CA FL MA MD NC NE NJ NY OH TX WA)** were observed at 7 or more locations in 2010.
